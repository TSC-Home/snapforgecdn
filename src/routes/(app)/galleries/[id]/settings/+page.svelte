<script lang="ts">
  ...
  let videoAudioBitrate = $state(
    data.gallery.videoAudioBitrate?.toString() ?? "",
  );
  let videoGenerateThumbnail = $state(
    data.gallery.videoGenerateThumbnail ?? true,
  );
  let videoThumbnailTime = $state(
    ...
    <div class="space-y-6 animate-in">
      ...
      <Card>
        ...
        >
          ...
          {/if}
          <Input name="name" label="Name" bind:value={galleryName} required />
      ...
      <Card>
        ...
        >
          ...
          <p class="text-sm text-gray-600">
            Configure how images are processed when uploaded. Leave fields empty
  ...
  {#if activeTab === "api"}
    <div class="space-y-6 animate-in">
      <Card>
        ...
        <div class="space-y-4">
          <p class="text-sm text-gray-600">
            Use these credentials to authenticate API requests. Keep the token
            secret!
          </p>
          ...
          <div>
            ...
            <div class="mt-2 flex gap-2">
              ...
              <Button
                ...
                variant="ghost"
                onclick={() =>
                  copyToClipboard(data.gallery.id, "Gallery ID copied")}
              >
                Copy
              </Button>
            </div>
          ...
          <div>
            ...
            <div class="mt-2 flex gap-2">
              ...
              <Button
                ...
                variant="ghost"
                onclick={() =>
                  copyToClipboard(data.gallery.accessToken, "Token copied")}
              >
                Copy
              </Button>
            </div>
      ...
      <Card>
        ...
        <div class="space-y-6">
          <div>
            ...
            <code
              class="block p-3 bg-gray-50 border border-gray-200 rounded-lg font-mono text-xs overflow-x-auto whitespace-pre"
              >POST /api/images/upload Authorization: Bearer {"<token>"}
              Content-Type: multipart/form-data file: (binary)</code
            >
          </div>
          ...
          <div>
            ...
            <code
              class="block p-3 bg-gray-50 border border-gray-200 rounded-lg font-mono text-xs"
            >
              GET /i/{"{imageId}"}?thumb&w=800&h=600&q=80
            </code>
            <p class="mt-2 text-xs text-gray-500">
              <span class="font-medium">Parameters:</span> thumb (thumbnail), w (width),
              h (height), q (quality 1-100)
            </p>
          </div>
          ...
          <div>
            ...
            <code
              class="block p-3 bg-gray-50 border border-gray-200 rounded-lg font-mono text-xs whitespace-pre"
          ...
          <div>
            ...
            <code
              class="block p-3 bg-gray-50 border border-gray-200 rounded-lg font-mono text-xs whitespace-pre"
              >GET /api/galleries/{data.gallery.id}/images Authorization: Bearer {"<token>"}</code
            >
          </div>
        </div>
      </Card>
        ...
        <div class="space-y-6">
          <div class="p-4 bg-red-50 border border-red-100 rounded-lg">
            ...
            <p class="text-sm text-red-700 mb-4">
              This will permanently delete this gallery and all {data.stats
                .imageCount} images. This action cannot be undone.
            </p>
            <form
              method="POST"
              action="?/delete"
